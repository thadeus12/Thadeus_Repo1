...
public class gotolink {
	...
	public static void main(String[] args) {
		...
		driver.get("https://www.mrandmrssmith.com/destinations");
		driver.manage().window().getSize();
		
		//String part1="html/body/div[6]/section/aside/article/section[1]/ul/li[";
		//String part2="]/a";
		
		String part1="html/body/div[6]/section/section[2]/div/a[";
		String part2="]";
		//for(int i=1;i<=5;i++){
