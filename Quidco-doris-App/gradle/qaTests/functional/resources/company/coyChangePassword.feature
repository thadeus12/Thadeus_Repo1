...
Feature: change own password
  ...
  Scenario Outline: User unsuccessfully update password
    ...
    Examples:
      ...
      | coy.sm   | pass1234 |                  | AG2716           | company |
      | coy.sm   | pass1234 | pass456790123456 | AG2713           | company |
      | coy.sm   | pass1234 | pass456%9012345$ | AG2713           | company |
      | coy.sm   | pass1234 | pass4            | AG2713           | company |
      | coy.sm   | pass1234 | 123456789012345  | AG2713           | company |
      | coy.sm   | pass1234 | abcdefghijklmno  | AG2713           | company |
  ...
  Scenario Outline: User successfully update password
    ...
    Examples:
      | username | password | newPassword | expectedResponse | site    |
      | coy.sm   | pass1234 | pass5678    | 0                | company |
