...
import com.test.smith.page.DetailsPaymentPage;
...
public class DetailsPaymentPage_sd {
    DetailsPaymentPage paymentDetails = PageFactory.initElements(Driver.driver, com.test.smith.page.DetailsPaymentPage.class);
